...
export default function Inventory() {
    const items = [
        { id: 1, name: 'DRY - XL Castle w Slide', size: '25 x 15', price: 250, imgUrl: DRY_XL },
        { id: 2, name: 'DRY - Large Castle', size: '15 x 15', price: 200, imgUrl: DRY_LARGE },
        ...
        { id: 12, name: 'Portable Generator', size: '4000W', price: 75, imgUrl: GENERATOR },
    ];
